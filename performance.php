...
<div class="title">
        ...
        <span class="heading">PERFORMANCE ANALYSIS</span>
    ...
    <div class="main">
        <div class="search">
            <form action="./analysisReport.php" method="get">
                <fieldset style="padding-top:10px;">
                    <legend>View Performance</legend>
                    ...
                    <input type="submit" value="ANALYSIS REPORT" >
                </fieldset>
            </form>
        </div>
    </div>
