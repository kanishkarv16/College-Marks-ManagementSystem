...
<?php
    if(isset($_POST['class_name'],$_POST['rno'])) {
        ...
        $rno=$_POST['rno'];
        $delete_sql=mysqli_query($conn,"DELETE from `results` where `rno`='$rno' and `class`='$class_name'");
        if(!$delete_sql){
    ...
    if(isset($_POST['rn'],$_POST['p1'],$_POST['p2'],$_POST['p3'],$_POST['p4'],$_POST['p5'],$_POST['p6'],$_POST['class'])) {
        ...
        $sql="UPDATE `results` SET `p1`='$p1',`p2`='$p2',`p3`='$p3',`p4`='$p4',`p5`='$p5',`p6`='$p6',`sgpa`='$percentage' WHERE `rno`='$rno' and `class`='$class_name'";
